export const translations = {
  ...
  verificationEmailSentDescription:
    "Hesabınızı təsdiqləmək üçün {email} ünvanına göndərilən e-poçtu yoxlayın. Davam etmək üçün e-poçtdakı təsdiq linkinə klikləyin.",
  resendVerificationEmail: "Təsdiq e-poçtunu yenidən göndər",
  backToLogin: "Giriş səhifəsinə qayıt",
  verificationEmailResent:
    "Təsdiq e-poçtu yenidən göndərildi. Gələn qutusunu yoxlayın.",
  ...
  // Error Messages
  apiConnectionFailed:
    "API-ə qoşulmaq mümkün olmadı. Zəhmət olmasa internet bağlantınızı yoxlayın.",
  userNotFound: "İstifadəçi tapılmadı",
  testNotFound: "Test tapılmadı",
  testDataIncomplete:
    "Test məlumatları natamamdır. Zəhmət olmasa yenidən cəhd edin.",
  ...
  verificationCodeExpired:
    "Təsdiq kodu müddəti bitib. Zəhmət olmasa yeni kod tələb edin.",
  invalidVerificationCode:
    "Yanlış təsdiq kodu. Zəhmət olmasa yenidən cəhd edin.",
